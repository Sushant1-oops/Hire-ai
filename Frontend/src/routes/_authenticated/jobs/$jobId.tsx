...
function JobDetailPage() {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    // Newly submitted applications are parsed/scored in the background —
    // poll while any are still pending so the score appears without a
    // manual refresh, and stop once everything has settled.
  ...
  // Optimistic update: the status dropdown feels instant instead of waiting
  // on a round trip, and rolls back automatically if the request fails.
