# V2 note
The V2 architecture work (PostgreSQL/pgvector, cross-encoder, Redis worker, Cloudinary, security hardening) is documented in `docs/V2_GAP_AUDIT.md`. Everything below is the earlier history.
